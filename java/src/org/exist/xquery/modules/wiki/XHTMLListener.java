...
public class XHTMLListener implements IWemListener {
	...
	private void onExtension(String name, String targetTag, String content, 
        ...
        attribs.addAttribute("", "class", "class", "CDATA", action.toString());

        builder.startElement(XHTML_NS, targetTag, targetTag, attribs);
		if (content != null) {
    ...
    public void onMacroBlock(String name, WikiParameters wikiParameters, String content) {
		onExtension(name, "div", content, wikiParameters);
    }

    public void onMacroInline(String name, WikiParameters wikiParameters, String content) {
		onExtension(name, "span", content, wikiParameters);
    }
